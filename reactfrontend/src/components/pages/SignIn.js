...
class SignIn extends Component {
	...
	render() {
		return (
			<div>
				<Typography sx={{margin: 2}} align='center' variant='h6'> Willkommen zum TimeTracker </Typography>
				<Typography sx={{margin: 2}} align='center'>Bitte loggen Sie sich ein</Typography>
